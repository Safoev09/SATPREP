        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-16 items-center">
          <div>
            ...
            <h1 className="font-display font-medium text-coffee-900 leading-[1.02] tracking-tight mb-6" style={{ fontSize: "clamp(2.8rem, 5.8vw, 4.6rem)" }}>
              <BlurReveal text="Master the SAT," as="span" />{" "}
              <BlurReveal
                text="the warm way."
                as="span"
                className="italic font-normal text-coffee-600"
                startDelay={300}
              />
            </h1>
            <BlurReveal
              as="p"
              text="A calmer way to prep. Skill-by-skill drills, real Bluebook-style mocks, and clear hand-written explanations for every wrong answer."
              className="text-coffee-600 text-xl max-w-xl mb-10 leading-relaxed"
              startDelay={550}
              delayStep={22}
            />
