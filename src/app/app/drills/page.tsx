  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <div className="text-center mb-10 mt-4">
        ...
        <h1 className="font-display text-4xl font-semibold text-coffee-900 mb-3">
          Drills
        </h1>
      ...
      <div className="glass rounded-3xl p-6 mb-8 max-w-3xl mx-auto">
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="font-display font-semibold text-coffee-900 mb-1.5">
              What is a drill?
            </div>
      ...
      <div className="grid sm:grid-cols-2 gap-5 mb-12">
        <Link
          href="/app/rw/drills"
          className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-accent/20 to-cream-200 p-8 border border-coffee-700/10 hover:scale-[1.015] transition-all duration-300"
        >
          <div className="text-5xl mb-4">📖</div>
          <div className="font-display text-2xl font-semibold text-coffee-900 mb-1">
            Reading & Writing
          </div>
          <div className="text-sm text-coffee-600 mb-4">
            Information & ideas, craft & structure, expression, grammar
          </div>
          <div className="inline-flex items-center gap-2 bg-coffee-800 text-cream-50 px-5 py-2.5 rounded-full text-sm font-medium group-hover:gap-3 transition-all">
            Start drilling
        ...
        <Link
          ...
          className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-coffee-800 to-coffee-900 p-8 border border-coffee-700/10 hover:scale-[1.015] transition-all duration-300"
        >
          <div className="text-5xl mb-4">🧮</div>
      ...
      <div className="max-w-3xl mx-auto">
        <div className="font-display text-xl font-semibold text-coffee-900 text-center mb-6">
          How it works
        </div>
        <div className="grid sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={s.t} className="text-center p-4">
              ...
              <div className="font-medium text-coffee-900 mb-1">{s.t}</div>
              <div className="text-xs text-coffee-600">{s.s}</div>
            </div>
          ))}
        </div>
      </div>
