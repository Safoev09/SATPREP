  ...
  if (done) {
    return (
      <div className="p-8 max-w-2xl mx-auto">
        <div className="bg-cream-50 dark:bg-midnight-100 border border-coffee-700/10 dark:border-cream-200/8 rounded-3xl p-10 text-center">
          <div className="text-5xl mb-3">✨</div>
          <h1 className="font-display text-3xl font-semibold text-coffee-900 dark:text-cream-50 mb-1">
            Review complete
          </h1>
          <p className="text-coffee-600 dark:text-cream-200/70 mb-6">
            You reviewed {queue.length} words.
          </p>
          <div className="flex justify-center gap-6 mb-8">
            <div>
              <div className="font-display text-3xl font-semibold text-coffee-900 dark:text-cream-50">
                {stats.correct}
              </div>
              <div className="text-xs text-coffee-500 dark:text-cream-200/50 uppercase tracking-wider">
                Knew it
              </div>
            </div>
            <div>
          ...
          <Link
            href="/app/vocabulary"
            className="inline-block bg-coffee-800 dark:bg-accent text-cream-50 px-6 py-2.5 rounded-full text-sm font-medium hover:scale-[1.02] transition"
          >
            Back to vocabulary
          </Link>
        </div>
    ...
    <div className="min-h-[calc(100vh-65px)] flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-xl">
          <div className="bg-cream-50 dark:bg-midnight-100 border border-coffee-700/10 dark:border-cream-200/8 rounded-3xl p-10 min-h-[300px] flex flex-col justify-center text-center">
            <div className="font-display text-4xl sm:text-5xl font-semibold text-coffee-900 dark:text-cream-50 mb-2">
              {current.word}
            </div>
            <div className="text-xs text-coffee-500 dark:text-cream-200/50 mb-6">
            ...
            {revealed ? (
              <div className="animate-[fadeup_0.4s_ease-out]">
                ...
                {current.example && (
                  <div className="mt-4 text-sm italic text-coffee-500 dark:text-cream-200/60">
                    "{current.example}"
                  </div>
                )}
              </div>
          ...
          {revealed && (
            <div className="mt-6 grid grid-cols-2 gap-3 animate-[fadeup_0.4s_ease-out]">
              <button
                onClick={() => grade(false)}
                className="px-6 py-3.5 rounded-2xl bg-cream-100 dark:bg-midnight-50 text-coffee-800 dark:text-cream-100 hover:scale-[1.02] hover:bg-cream-200 dark:hover:bg-midnight-50/80 transition"
              >
                <div className="font-medium">Didn't know</div>
                <div className="text-xs text-coffee-500 dark:text-cream-200/50">Review tomorrow</div>
              </button>
              <button
                onClick={() => grade(true)}
                className="px-6 py-3.5 rounded-2xl bg-coffee-800 dark:bg-accent text-cream-50 hover:scale-[1.02] transition"
              >
